...
- **Wallet & Market** — balance, transactions with realized FIFO profit/loss, contracts with buy-vs-market-value profitability, an LP store browser ranked by ISK-per-LP, a market browser/price checker, and a screener with same-region spread and inter-region hauling modes.
