...
export const HELP_CONTENT: Record<string, HelpContent> = {
  ...
  "industry.production": {
    ...
    gives: "A real total cost priced off actual Trade Hub sell orders, a build-vs-buy verdict for every material in the chain, and a Multibuy-ready shopping list for exactly the items you tick.",
  },
